    ...
    return (
        <div style={{border: "2px solid black", marginBottom: "2px", padding: "7px"}}> 
            ...
            <span>
                ...
                <a href={`https://twitter.com/${props.user.screen_name}/status/${props.id}`} target="_blank" style={{float: "right", marginRight: "5px"}}>            <i className="fab fa-twitter fa-2x"></i> See full tweet</a>
